...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, 'src/indexWeb'),
  appPackageJson: resolveApp('package.json'),
  appSrc: resolveApp('src'),
  //appRoot:resolveApp('../src/size/large/app'),
  //appTsConfig: resolveApp('tsconfig.json'),
  appJsConfig: resolveApp('package.json'),
  ...
  swSrc: resolveModule(resolveApp, 'src/sw-helper/sw'),
  publicUrlOrPath,
};
